...
class PerlinNoise {
  ...
  public function new( seed = 666, octaves = 4, falloff = 0.5 ) {
  ...
  public function make(width:Int, height:Int, _x:Float, _y:Float, _z:Float, ?_ ):Array<Array<Int>> {
    ...
    for ( py in 0...height )
    {
      ...
      for ( px in 0...width )
      {
        ...
        Array2dCore.set(bitmap, px, py, 0xff000000 | color << 16 | color << 8 | color );
