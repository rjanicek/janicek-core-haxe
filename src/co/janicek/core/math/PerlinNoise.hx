...
class PerlinNoise {
	...
	public static function makePerlinNoise(width:Int, height:Int, _x:Float, _y:Float, _z:Float, seed = 666, octaves = 4, falloff = 0.5, ?_  ) : Array<Array<Int>> {

		var baseFactor:Float = 1 / 64;
		
		var iXoffset = seed = Std.int((seed * 16807.) % 2147483647);
		var iYoffset = seed = Std.int((seed * 16807.) % 2147483647);
		var iZoffset = seed = Std.int((seed * 16807.) % 2147483647);
		...
		var bitmap = new Array<Array<Int>>();
